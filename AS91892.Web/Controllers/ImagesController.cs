...
/// </summary>
[Route("Images")]
public class ImagesController : ControllerWithRepo<ImagesController, IImageRepository, Image>
{
    /// <summary>
    ...
    public ImagesController(ILogger<ImagesController> logger, IImageRepository repository) : base(logger, repository)
    {
    }
}
